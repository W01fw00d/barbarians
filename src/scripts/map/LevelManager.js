function LevelManager(browserUtils, mapDesign, soundManager, startingMapLevel) {
  ...
  var showNextMapMsg = function (currentMapLevel) {
    ...
    const win_message_spa =
      "¡Felicidades, has completado el juego! Esos bárbaros no volverán a amenazar la bella Roma... ¿O tal vez ésto solo sea el principio?";
