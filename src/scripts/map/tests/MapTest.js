describe("Map", () => {
  ...
  describe("when cell is N", () => {
    ...
    it("a Neutral Town shall be created", () => {
      ...
      expect(JSON.stringify(players.neutral.units.towns[0])).toBe(
  ...
  describe("when cell is A", () => {
    ...
    it("a Roman Human Town shall be created", () => {
      ...
      expect(JSON.stringify(players.human.units.towns[0])).toBe(
        JSON.stringify(resultObject)
      );
    });
  });
  ...
  describe("when cell is E", () => {
    ...
    it("a Barbarian AI Town shall be created", () => {
      ...
      expect(JSON.stringify(players.ai.units.towns[0])).toBe(
        JSON.stringify(resultObject)
      );
    });
  });
  ...
  describe("when cell is n", () => {
    ...
    it("a Neutral Wolf Pack shall be created", () => {
      ...
      expect(JSON.stringify(players.neutral.units.mobs[0])).toBe(
        JSON.stringify(resultObject)
      );
    });
  });
  ...
  describe("when cell is a", () => {
    ...
    it("a Roman Human Soldier shall be created", () => {
      ...
      expect(JSON.stringify(players.human.units.mobs[0])).toBe(
        JSON.stringify(resultObject)
      );
    });
  });
  ...
  describe("when cell is e", () => {
    ...
    it("a Barbarian AI Soldier shall be created", () => {
      ...
      expect(JSON.stringify(players.ai.units.mobs[0])).toBe(
        JSON.stringify(resultObject)
      );
    });
  });
