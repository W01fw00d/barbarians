...
IconTemplates.prototype.getBase = function(id, title, img) {
    return '<a id="tooltip' + id + '" href="#" data-toggle="tooltip" title="' + title + '">'
        + '<img class="icon" id="icon' + id + '" src="./src/images/board/' + img + '.png"></img></a>';
}
...
IconTemplates.prototype.getUsedHumanMob = function(id, name, movements, strength) {
